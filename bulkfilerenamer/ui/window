...
class Ui_Window(object):
    ...
    def retranslateUi(self, Window):
        ...
        Window.setWindowTitle(_translate("Window", "Bulk File Renamer"))
        ...
        self.label_4.setText(_translate("Window", "Preferred Name:"))
        self.prefixEdit.setPlaceholderText(
            _translate("Window", "Enter your preferred name...")
        )
